...
- **FindMeOn and Footer:** both removed (user review feedback 2026-07-27) —
  FindMeOn duplicated the existing SocialMedia icon rows in the hero and
  contact sections. The GithubCard contact section closes the page.
